...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "* {\n  box-sizing: border-box;\n  margin: 0;\n  padding: 0;\n}\n\nbody {\n  color: #383131;\n}\n\n#logo {\n  color: #A25F08;\n  font-size: 3.052rem;\n  padding: 0 15px;\n  line-height: 0;\n}\n\nh1 {\n  font-size: 3.815rem;\n}\n\n.h1-doo {\n  color: #A25F08;\n}\n\nh2 {\n  font-size: 1.953rem;\n}\n\nh3 {\n  font-size: 1.563rem;\n}\n\n#main-header {\n  display: flex;\n  background-color: #b8e6ff;\n  padding: 40px 20px;\n  align-items: center;\n  box-shadow: 1px 5px 5px #808080;\n  position: relative;\n}\n\nmain {\n  display: flex;\n  min-height: calc(100vh - 130px - 60px);\n}\n\nnav {\n  background-color: #fffec1;\n  width: 350px;\n  padding: 20px;\n  border-top-right-radius: 50px;\n  border-bottom-right-radius: 50px;\n}\n\n#nav-header, #tasks, #projects {\n  margin-bottom: 25px;\n}\n\n#nav-header {\n  display: flex;\n}\n\n#tasks {\n  display: flex;\n  flex-direction: column;\n}\n\n#projects {\n  display: flex;\n  flex-direction: column;\n}\n\n#content {\n  width: 1000px;\n}\n\n.modules {\n  display: flex;\n  flex-direction: column;\n  width: 100%;\n  margin: 50px;\n}\n\n.modules > button {\n  padding: 15px 20px;\n  font-size: 1.25rem;\n}\n\nfooter {\n  background-color: #f4d570;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  padding: 30px;\n  /*border-top-left-radius: 25px;*/\n  /*border-top-right-radius: 25px;*/\n}\n\nbutton {\n  border-style: none;\n  background-color: #fffec1;\n  text-align: left;\n  border-radius: 15px;\n}\n\nbutton:hover {\n  background-color: #f1f1f1;\n}\n\n#tasks > button, #projects > button {\n  padding: 15px 20px;\n  font-size: 1.25rem;\n}\n\n#tasks > button:active, #projects > button:active {\n  background-color: #A25F08;\n}\n\n.todo--container {\n  display: flex;\n  justify-content: space-between;\n  background-color: lightgreen;\n  padding: 15px 20px;\n  margin-bottom: 5px;\n  border-radius: 15px;\n}\n\n.todo--complete {\n  font-size: 1.25rem;\n}\n\n.new-task {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  border: none;\n  height: 50px;\n  width: 50px;\n  border-radius: 50%;\n  position: fixed;\n  bottom: 50px;\n  right: 50px;\n  z-index: 1000;\n  outline: transparent;\n  background: linear-gradient(135deg, #A25F08 0%, #824c05 100%);\n  color: #fff;\n  box-shadow: 0px 3px 5px -1px rgba(0, 0, 0, 0.2), 0px 6px 10px 0px rgba(0, 0, 0, 0.14), 0px 1px 18px 0px rgba(0, 0, 0, 0.12);\n}\n\n.new-task:hover {\n  transform: rotate(90deg) scale(1.2);\n  cursor: pointer;\n}\n\n.new-task:active {\n  filter: opacity(80%);\n}\n\n.new-task {\n  transition: transform 0.25s, opacity 0.25s;\n}\n\n.new-task i {\n  font-size: 2rem;\n  line-height: 1.2;\n  border-radius: 50%;\n}", "",{"version":3,"sources":["webpack://./src/styles/main.css"],"names":[],"mappings":"AAAA;EACI,sBAAA;EACA,SAAA;EACA,UAAA;AACJ;;AAEA;EACI,cAAA;AACJ;;AAEA;EACI,cAAA;EACA,mBAAA;EACA,eAAA;EACA,cAAA;AACJ;;AAEA;EACI,mBAAA;AACJ;;AAEA;EACI,cAAA;AACJ;;AAEA;EACI,mBAAA;AACJ;;AAEA;EACI,mBAAA;AACJ;;AAEA;EACI,aAAA;EACA,yBAAA;EACA,kBAAA;EACA,mBAAA;EACA,+BAAA;EACA,kBAAA;AACJ;;AAEA;EACI,aAAA;EACA,sCAAA;AACJ;;AAEA;EACI,yBAAA;EACA,YAAA;EACA,aAAA;EACA,6BAAA;EACA,gCAAA;AACJ;;AAEA;EACI,mBAAA;AACJ;;AAEA;EACI,aAAA;AACJ;;AAEA;EACI,aAAA;EACA,sBAAA;AACJ;;AAEA;EACI,aAAA;EACA,sBAAA;AACJ;;AAEA;EACI,aAAA;AACJ;;AAEA;EACI,aAAA;EACA,sBAAA;EACA,WAAA;EACA,YAAA;AACJ;;AAEA;EACI,kBAAA;EACA,kBAAA;AACJ;;AAEA;EACI,yBAAA;EACA,aAAA;EACA,uBAAA;EACA,mBAAA;EACA,aAAA;EACA,gCAAA;EACA,iCAAA;AACJ;;AAEA;EACI,kBAAA;EACA,yBAAA;EACA,gBAAA;EACA,mBAAA;AACJ;;AAEA;EACI,yBAAA;AACJ;;AAEA;EACI,kBAAA;EACA,kBAAA;AACJ;;AAEA;EACI,yBAAA;AACJ;;AAEA;EACI,aAAA;EACA,8BAAA;EACA,4BAAA;EACA,kBAAA;EACA,kBAAA;EACA,mBAAA;AACJ;;AAEA;EACI,kBAAA;AACJ;;AAEA;EACI,aAAA;EACA,uBAAA;EACA,mBAAA;EACA,YAAA;EACA,YAAA;EACA,WAAA;EACA,kBAAA;EACA,eAAA;EACA,YAAA;EACA,WAAA;EACA,aAAA;EACA,oBAAA;EACA,6DAAA;EACA,WAAA;EACA,2HAAA;AACJ;;AAEA;EACI,mCAAA;EACA,eAAA;AACJ;;AAEA;EACI,oBAAA;AACJ;;AAEA;EACI,0CAAA;AACJ;;AAEA;EACI,eAAA;EACA,gBAAA;EACA,kBAAA;AACJ","sourcesContent":["* {\n    box-sizing: border-box;\n    margin: 0;\n    padding: 0;\n}\n\nbody {\n    color: #383131;\n}\n\n#logo {\n    color: #A25F08;\n    font-size: 3.052rem;\n    padding: 0 15px;\n    line-height: 0;\n}\n\nh1 {\n    font-size: 3.815rem;\n}\n\n.h1-doo {\n    color: #A25F08;\n}\n\nh2 {\n    font-size: 1.953rem;\n}\n\nh3 {\n    font-size: 1.563rem;\n}\n\n#main-header {\n    display: flex;\n    background-color: #b8e6ff;\n    padding: 40px 20px;\n    align-items: center;\n    box-shadow: 1px 5px 5px #808080;\n    position: relative;\n}\n\nmain {\n    display: flex;\n    min-height: calc(100vh - 130px - 60px);\n}\n\nnav {\n    background-color: #fffec1;\n    width: 350px;\n    padding: 20px;\n    border-top-right-radius: 50px;\n    border-bottom-right-radius: 50px;\n}\n\n#nav-header, #tasks, #projects {\n    margin-bottom: 25px;\n}\n\n#nav-header {\n    display: flex;\n}\n\n#tasks {\n    display: flex;\n    flex-direction: column;\n}\n\n#projects {\n    display: flex;\n    flex-direction: column;\n}\n\n#content {\n    width: 1000px;\n}\n\n.modules {\n    display: flex;\n    flex-direction: column;\n    width: 100%;\n    margin: 50px;\n}\n\n.modules > button {\n    padding: 15px 20px;\n    font-size: 1.25rem;\n}\n\nfooter {\n    background-color: #f4d570;\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    padding: 30px;\n    /*border-top-left-radius: 25px;*/\n    /*border-top-right-radius: 25px;*/\n}\n\nbutton {\n    border-style: none;\n    background-color: #fffec1;\n    text-align: left;\n    border-radius: 15px;\n}\n\nbutton:hover {\n    background-color: #f1f1f1;\n}\n\n#tasks > button, #projects > button {\n    padding: 15px 20px;\n    font-size: 1.25rem;\n}\n\n#tasks > button:active, #projects > button:active {\n    background-color: #A25F08;\n}\n\n.todo--container {\n    display: flex;\n    justify-content: space-between;\n    background-color: lightgreen;\n    padding: 15px 20px;\n    margin-bottom: 5px;\n    border-radius: 15px;\n}\n\n.todo--complete {\n    font-size: 1.25rem;\n}\n\n.new-task {\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    border: none;\n    height: 50px;\n    width: 50px;\n    border-radius: 50%;\n    position: fixed;\n    bottom: 50px;\n    right: 50px;\n    z-index: 1000;\n    outline: transparent;\n    background: linear-gradient(135deg, #A25F08 0%, #824c05 100%);\n    color: #fff;\n    box-shadow: 0px 3px 5px -1px rgb(0 0 0 / 20%), 0px 6px 10px 0px rgb(0 0 0 / 14%), 0px 1px 18px 0px rgb(0 0 0 / 12%);\n}\n\n.new-task:hover {\n    transform: rotate(90deg) scale(1.2);\n    cursor: pointer;\n}\n\n.new-task:active {\n    filter: opacity(80%);\n}\n\n.new-task {\n    transition: transform 0.25s, opacity 0.25s;\n}\n\n.new-task i {\n    font-size: 2rem;\n    line-height: 1.2;\n    border-radius: 50%;\n}"],"sourceRoot":""}]);
// Exports
...
if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', _modules_interface__WEBPACK_IMPORTED_MODULE_1__["default"])
} else {
    (0,_modules_interface__WEBPACK_IMPORTED_MODULE_1__["default"])();
}
})();

/******/ })()
;
//# sourceMappingURL=bundle992aaffbb7e9b4ed4057.js.map